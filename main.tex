...
\begin{sol}~
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \begin{align*}
            ...
            \beta^2 \sqrt{7}  & = (- \sqrt{7} - \gamma)^2 \\
            & = 7 + 2\gamma \sqrt{7}  + \gamma^2 \\
        ...
        \]
        \item We know that $\sqrt[4]{7} \in \Q(\alpha)$ which has minimal polynomial $f(\sqrt[4]{7},\Q) = x^4-7$. One root of this polyomial is $i\sqrt[4]{7} \not\in \Q(\alpha)$, therefore $\Q(\alpha):\Q$ is not normal.
    \end{enumerate}
\end{sol}
...
$f(y,K)=f(x,K)$ for all $y\in O_G(x)$.
    \begin{description}[font=\normalfont]
        ...
        By Proposition 5.16 of the lecture notes, we alsodhave that $\gamma(K(x)/K)=|O_G(x)|$.
        Thus 
